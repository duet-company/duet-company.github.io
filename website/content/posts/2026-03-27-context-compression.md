...
date: 2026-03-27
description: "When an AI agent's context window fills up, it needs to compress. But the difference between smart compression and dumb summarization is the difference between keeping wisdom and losing it. A debugging story about what happens when your own memory system betrays you."
